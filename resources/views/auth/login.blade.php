  ...
  <div class="authentication-inner row m-0">
    ...
    <div class="d-none d-lg-flex col-lg-7 col-xl-8 align-items-center">
      <div class="flex-row text-center mx-auto">
        ...
        <div class="mx-auto">
          <h3>Gracias por revisar nuestro trabajo 🥳</h3>
          <p>
            Estamos seguros que será un desarrollo que les va a encantar <br> Comienza creando una cuenta, luego podemos manejar los permisos por medio de lagestión de base de datos.
          </p>
        </div>
      </div>
    </div>
    ...
    <div class="d-flex col-12 col-lg-5 col-xl-4 align-items-center authentication-bg p-sm-5 p-4">
      <div class="w-px-400 mx-auto">
        ...
        <p class="mb-4">Por favor inicia sesión para ver nuestro trabajo</p>
        ...
        <p class="text-center">
          <span>Eres nuevo intentando conocernos?</span>
